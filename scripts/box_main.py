...
def main():
    ...
    N = 13                                      # number of QDs in each dimension
    ...
    method = 'exact'
    r_hop = 6                                   # hopping radius (see Kassal) (in units of lattice spacing)
    r_ove = 6                                   # overlap radius (see Kassal) (in units of lattice spacing)
